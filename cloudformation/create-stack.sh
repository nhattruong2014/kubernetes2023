...
# aws cloudformation create-stack --stack-name "$server_stack_name" --template-body file://"$server_template" --parameters file://"$server_parameters" --capabilities CAPABILITY_IAM
aws cloudformation create-stack --stack-name "$server_stack_name" --template-body file://"$server_template" --capabilities CAPABILITY_IAM
